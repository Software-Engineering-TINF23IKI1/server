...
from bbc_game.point_earning import PointDistributer, PointDistributerFactory

class GameConfig:
    def __init__(self, point_earning: PointDistributer, shop: Optional[ShopType] = None, base_currency: float = 0, base_earn_rate: float = 0,
                 base_modifier: float = 1):
...
class GameConfigFactory:
    def __init__(self, point_earning_factory: PointDistributerFactory, shop: Optional[ShopType] = None, base_currency: float = 0, base_earn_rate: float = 0,
                 base_modifier: float = 1):
        self.shop = shop
        self.base_currency = base_currency
        self.base_earn_rate = base_earn_rate
